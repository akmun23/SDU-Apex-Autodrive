...
#define STEERING_RATE_LIMIT 3.2f                         /* AutoDRIVE 2026 centre-steering rate limit [rad/s]. */
...
#define VP_MAX_VELOCITY_MPS 22.88f                       /* AutoDRIVE 2026 documented top speed [m/s]. */
#define VP_MIN_VELOCITY_MPS 0.5f                         /* Lower velocity limit used by vehicle model clamping logic. */
#define VP_CG_TO_FRONT_AXLE_M 0.16868f                   /* AutoDRIVE wheelbase minus rear-axle-to-COM distance [m]. */
#define VP_CG_TO_REAR_AXLE_M 0.15532f                    /* AutoDRIVE rear-axle-to-COM distance [m]. */
